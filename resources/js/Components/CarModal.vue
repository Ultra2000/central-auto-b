...
const adjustDuration = (delta) => {
    ...
    if (newValue >= 1) rentalDuration.value = newValue;
};
    ...
    <div v-if="isOpen && car" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" @click.self="close">
        <div class="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto transform transition-all duration-300">
            ...
            <div class="relative">
                ...
                <div v-if="car.badge_type" class="absolute top-4 left-4 px-4 py-2 rounded-full text-white text-sm font-bold uppercase tracking-wide shadow-lg backdrop-blur-sm"
            ...
            <div class="p-8">
                ...
                <div class="flex justify-between items-start mb-6 pb-6 border-b-2 border-slate-100">
                    ...
                    <div class="text-right">
                        <p class="text-4xl font-extrabold" :class="car.type === 'sale' ? 'text-brand-blue' : 'text-brand-red'">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <button @click="contact" class="flex-1 bg-brand-gradient text-white font-bold py-4 rounded-xl hover:opacity-90 transition-all shadow-lg flex items-center justify-center gap-3 hover:-translate-y-1 transform duration-300">
                        <i class="ph-bold ph-phone text-xl"></i>
                        <span>Contacter pour ce véhicule</span>
                    </button>
